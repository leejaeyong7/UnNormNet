...
from dataset.imgnet_homo import ImagenetHomo
...
def parse_option():
    ...
    parser.add_argument('--aug', type=str, default='Homo', choices=['NULL', 'CJ', 'Homo'])
...
def main():
    ...
    train_dataset = ImagenetHomo(data_folder, aug_config='./dataset/configs/debug.yaml', transform=train_transform)
